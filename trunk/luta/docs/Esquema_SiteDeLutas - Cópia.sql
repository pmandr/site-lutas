CREATE TABLE EventoDeLuta(
      ...
      CONSTRAINT fk_loc FOREIGN KEY (lugar) REFERENCES Lugar(nomeLoc) ON DELETE CASCADE ON UPDATE CASCADE,
      ...
      CONSTRAINT max_cap CHECK(qtdIngressosOferecidos <= Lugar(capacidade))
);
...
CREATE TABLE CanaisEmissora(
     ...
     CONSTRAINT fkCanal FOREIGN KEY (emissora) REFERENCES Emissora(CNPJ) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Ingresso(
     ...
     CONSTRAINT fkEve FOREIGN KEY(numEvento) REFERENCES EventoDeLuta(nro) ON DELETE CASCADE ON UPDATE CASCADE,
     CONSTRAINT fkCompra FOREIGN KEY(compra) REFERENCES Compra(nroCompra) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE Compra(
     ...
     CONSTRAINT fkComprad FOREIGN KEY (comprador) REFERENCES Comprador(CPF) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE TelsCliente(
     ...
     CONSTRAINT pkCar PRIMARY KEY(cliente, telefone),
     CONSTRAINT fkCar FOREIGN KEY(cliente) REFERENCES Cliente(CPF) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE TelsPontoDeVenda(
     ...
     CONSTRAINT pkTels PRIMARY KET (pontoDeVenda, telefone),
     CONSTRAINT fkTels FOREIGN KEY (pontoDeVenda) REFERENCES PontoDeVenda(nome) ON DELETE CASCADE ON UPDATE CASCADE
);
